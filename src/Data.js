...
const data = [
  ...
  },
  {
    ...
    image: two,
    answers: [
      "Egg shells,bat wings and digestive biscuits.",
      "Cat hair,feathers and cat liter.",
      "Beetle dung,dead wasps and bourbon biscuits.",
      "Frogspawn,cockroaches and custard creams."
    ],
  ...
  },
  {
    ...
    answers: [
      ...
      "Theodore Snape and Ethel Prince",
      "Tripp Snape and Eliana Prince",
      "Toby Snape and Ellen Prince"
    ],
  ...
  {
    question:
      "What was the codename that Fred was mistakenly called on Potterwatch?",
    image: four,
    answers: ["Rabbit", "Rodent", "Rapier", "Rattlesnake"],
    correct: "Rodent",
    questionId: "4"
  },
  {
  ...
  },
  {
    ...
    image: seven,
    answers: [
      "Eels with humpbacks and legs",
      "Mouthless snakes with hands",
      "Overcooked and slimy prawns",
      "Deformed,shell-less lobsters"
    ],
  ...
  {
    question:
      "What type of hat was Elphias Doge wearing at Bill and Fleur’s wedding?",
    image: nine,
    answers: [
      "A suspiciously stained wizard's hat",
  ...
  {
    question:
      "Who gave Ambrosius Flume, the manager of Honeydukes Sweetshop, his first job?",
    image: ten,
    answers: [
      "Horace Slughorn",
      "Florean Fortescue",
  ...
  {
    question:
      "In the book, what colour were the dress robes that Padma Patil wore to the Yule Ball?",
    image: twelve,
  ...
  {
    question:
      "What does Romilda Vane ask Ginny about Harry in Half Blood Prince?",
    image: thirteen,
    answers: [
      "Whether he looks like a mole without his glasses on",
      "Whether he has a Hippogriff tattoo",
      "Whether,when touched,his scar burns",
      "Whether he is actually the Chosen One"
    ],
